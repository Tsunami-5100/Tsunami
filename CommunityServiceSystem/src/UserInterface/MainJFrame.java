...
public class MainJFrame extends javax.swing.JFrame{
    ...
    public MainJFrame() {
        ...
        this.setSize(1800, 1250);
        Container.setPreferredSize(new Dimension(1800, 1250));
        JPanel.setPreferredSize(new Dimension(1800, 1240));
...
//        t.start();
    ...
    public void scaleImage() {
        ImageIcon icon = new ImageIcon("D:\\Courses\\2020Fall\\INFO5100\\Aassignements\\FinalProject\\CommunityServiceSystem_2.2\\src\\UserInterface\\images\\icons8-communityservice.png");
    ...
    private void initComponents() {
        ...
        JPanel.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 590, -1, -1));

        txtLoginId.setFont(new java.awt.Font("Arial", 0, 20)); // NOI18N
        JPanel.add(txtLoginId, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 640, 570, 49));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 22)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(58, 83, 155));
        jLabel3.setText("Password:");
        JPanel.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 750, -1, -1));
        ...
        JPanel.add(btnLogIn, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 910, 560, 50));
        ...
        JPanel.add(labelImage, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1800, 450));
        ...
        JPanel.add(fieldPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 790, 570, 49));

        labToRegister.setBackground(new java.awt.Color(58, 83, 155));
        labToRegister.setFont(new java.awt.Font("Tahoma", 0, 22)); // NOI18N
        labToRegister.setForeground(new java.awt.Color(58, 83, 155));
        labToRegister.setText("No account yet?");
        ...
        JPanel.add(labToRegister, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 1010, -1, -1));
