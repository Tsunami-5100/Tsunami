...
public class EnterpriseDirectory {
    ...
    public Enterprise AddEnterprise(String name, Enterprise.EnterpriseType type){
        ...
        else if(type==Enterprise.EnterpriseType.Kindergarten){
            enterprise=new KindergartenEnterprise(name);
            enterpriseList.add(enterprise);
        }
        else if(type==Enterprise.EnterpriseType.Property){
    ...
    public boolean checkIfEpNameIsUnique(String name){
