...
import UserInterface.BookTickets.ManageCustomer;
...
public class ManagerWorkArea extends javax.swing.JPanel {
    ...
    public ManagerWorkArea(JPanel Container, AirlinerCatalog ac, CustomerDirectory customerDirectory) {
       initComponents();
    ...
    private void btnBookTicketsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBookTicketsActionPerformed
        ManageCustomer ma = new ManageCustomer(Container, cd,airlinerCatalog);
        Container.add("ManageCustomer", ma);
