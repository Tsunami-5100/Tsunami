...
public class TicketCatalog {
    ...
    public ArrayList<Ticket> listTicket(){
        ...
        Ticket ticket2 = new Ticket("1A","window","500","availability","null");
        Ticket ticket3 = new Ticket("1A","window","500","availability","null");
        Ticket ticket4 = new Ticket("1A","window","500","availability","null");
        Ticket ticket5 = new Ticket("1A","window","500","availability","null");
